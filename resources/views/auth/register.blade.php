    ...
    <div class="flex text-white VK-Sans justify-center rounded-3xl bg-opacity-15 bg-gray-600 backdrop-blur-md mt-4 py-10 px-10 h-full ">
        ...
        <form method="POST" action="{{ route('register.submit') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('login.screen') }}">
